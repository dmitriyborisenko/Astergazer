...
<div class="div-middle-wrapper">
	<div class="div-panel-checklists">
        ...
        <div class="div-checklists-panel-header">
			...
			<button id="button-edit" class="ui-button" onclick="editCurrentTreeNode()"><spring:message code="checklists.edit" /></button>
			<button id="button-delete" class="ui-button" onclick="deleteCurrentTreeNode()"><spring:message code="checklists.delete" /></button>
		</div>
