...
public class Block implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        Block resultBlock = (Block) super.clone();
        resultBlock.setId(null);
        resultBlock.setScript(null);
        List<BlockParameter> resultParameters = new ArrayList<>();
        for (BlockParameter parameter : parameters) {
            BlockParameter resultParameter = (BlockParameter) parameter.clone();
            resultParameter.setBlock(resultBlock);
            resultParameters.add(resultParameter);
        }
        resultBlock.setParameters(resultParameters);
        return resultBlock;
    }
